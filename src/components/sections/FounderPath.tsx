    ...
    <section className={styles.section} id="journey">
      <PageContainer>
        <div className={styles.heading}>
          <SectionIntro eyebrow="مسیر بنیان‌گذار" title="از درخواست تا روبه‌رو شدن با سرمایه‌گذار، شفاف و قابل پیگیری." />
        ...
        <div className={styles.steps} ref={ref}>
          ...
          {journeySteps.map((step, index) => (
            <motion.article key={step.number} initial={reduceMotion ? false : { opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : undefined} transition={{ delay: reduceMotion ? 0 : 0.18 * index }}>
