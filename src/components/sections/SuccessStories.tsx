          ...
          {stories.map((story, index) => (
            ...
            >
              <div className={`${styles.storyVisual} ${styles[story.tone]}`}>
                <div className={styles.logo} aria-label={`لوگوی ${story.company}`}>{story.logo}</div>
              ...
              <div className={styles.storyCopy}>
                ...
                <div className={styles.founder}>
                  ...
                  <span><strong>{story.founder}</strong><small>{story.role}</small></span>
                </div>
                <div className={styles.metric}><strong>{story.metric}</strong><span>{story.metricLabel}</span></div>
              </div>
            </motion.article>
          ))}
        </div>
