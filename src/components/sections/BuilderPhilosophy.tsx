...
export function BuilderPhilosophy() {
  ...
  return (
    <section className={styles.section} id="philosophy">
      <PageContainer>
        <motion.div className={styles.statement} initial={reduceMotion ? false : { opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.45 }}>
          <span>نگاه ما</span>
          <h2>شتاب‌دهی مبتنی بر داده،<br /><em>بدون بوروکراسی دانشگاهی.</em></h2>
          <p>اینجا اعتبار یک ایده از عنوان دانشگاهی‌اش نمی‌آید؛ از مسئله واقعی، تیم متعهد و توان یادگیری سریع می‌آید.</p>
        </motion.div>
